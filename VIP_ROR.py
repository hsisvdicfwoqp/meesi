...
def lo(word):
    ...
    for i in range(5):
        for x in range(len(heron)):
            ...
            time.sleep(0.1)
            sys.stdout.flush()
lo("     ⃪⃪⃪⃪⃪⃪⃪W⃪a⃪i⃪t, ⃪m⃪y ⃪l⃪o⃪v⃪e...")
...
\x1b[1;33m• By 𝅄 火 - ⃪ا⃪ل-⃪م⃪ط⃪و⃪ر  @FF22L •
...
\nBy ميسي \n:『@FF22L 』⏎'\n\n\t\t\t\t\t
					...
					infoakun += f''' ▄︻デ══━一 MESSI «𝗢𝗞 🥬 حساب شغال 
 » ⏎

★✵★☆✵★☆✵★☆✵★☆✵★☆✵★☆
					
 (✪) Username☆اليميل 𖡲 : {idf}
 
(✪) Password ☆باسورد 𖡲 : {pw}

❖ - 𝐂𝐎𝐎𝐊𝐈𝐄𝐒 : {kuki}

★✵★☆✵★☆✵★☆✵★☆✵★☆✵★☆
:لاتنسه صور الصيد『@FF22L 』⏎'''
